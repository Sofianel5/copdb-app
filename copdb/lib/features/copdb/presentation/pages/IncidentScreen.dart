...
class _IncidentScreen extends State<IncidentScreen> {
  ...
  List<ReportPreview> reportList = [
    ReportPreview('first fullname', 'lastname', Icons.smoking_rooms, 'date/00',
        'lorem iptsum ido mina foli isa noream '),
    ReportPreview('first fullname', 'lastname', Icons.record_voice_over,
        'date/00', 'lorem iptsum ido mina foli isa noream '),
                ...
                MaterialPageRoute(
                    builder: (context) => ReportDetailScreen(
                          report: CopDBComplaint(
                            ...
                            description:
                                'lorem iptsum ido mina foli isa moream',
                          ),
                          index: index,
                        )),
              );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(bottom: 4),
                  child: Text('What are some examples of an incident?',
                      style:
            ...
            child: Column(
                ...
                children: [
                  ...
                  hasMadeReport
                      ...
                      : Container(
                          child: Text(
                            'You currently have not made any reports',
                            style:
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        SlideFromBottomPageRoute(widget: BadgeScreen()));
                  },
                  child: Container(
                    alignment: Alignment.center,
                    width: 120,
